"""固定 DSH SDK的同步 stdio JSON-RPC客户端与 MW进程工厂补丁。"""
...
class HarnessClient:
    ...
    def start(self) -> None:
        ...
        process_factory = self.config.process_factory or subprocess.Popen
    ...
    def stderr_lines(self) -> tuple[str, ...]:
        """Return the bounded Runtime stderr snapshot for host diagnostics and URL discovery."""
