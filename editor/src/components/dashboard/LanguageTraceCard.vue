...
const contextMode = ref<'raw' | 'readable'>('raw')
...
/** 上下文拼装的安全读取 */
const contextAssemblyState = computed(() => obs.contextAssembly?.value ?? { blocks: [], stats: { blockCount: 0, lineCount: 0, memoryCount: 0, knowledgeCount: 0 } })
