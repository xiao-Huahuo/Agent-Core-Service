 ...
 */
function syncGraphHighlights(): void {
    ...
    <div v-else class="queue-body">
      <div class="queue-pools">
        ...
        >
          ...
          <div v-if="(poolTasks[pool.id] || []).length === 0" class="task-empty">
